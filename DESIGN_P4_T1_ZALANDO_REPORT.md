...
| شاشة LENS المفتوحة (`.lens-home` + `.lens-drop`) | — | **0.596 %** | 3 % |
...
`zalando-before-*.png` (قبل) مقابل `zalando-*.png` (بعد)، لكلٍّ من الصفحة الرئيسية وقسم LENS وبطاقة «Découvrez AYROVI»، بقياسَي الجوال وسطح المكتب.
