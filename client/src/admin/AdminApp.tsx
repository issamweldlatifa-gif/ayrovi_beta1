...
const navGroups = [
  ...
  { label: 'Contenu', items: [
    ...
    { id: 'hero-visuals', label: 'Hero Management', icon: Image, permission: 'content:read' as Permission }, { id: 'ticker', label: 'Ticker annonces', icon: Bell, permission: 'content:read' as Permission },
  ]},
