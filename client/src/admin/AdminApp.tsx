...
const DesignPage:React.FC<{canWrite:boolean}>=({canWrite})=>{
  ...
  return <><PageHeader title="Développement & design" description="Système AYROVI 70% blanc / 25% noir / 5% orange. L’orange sert à l’attention (CTA, actif, indicateur), pas à décorer. Plus Jakarta Sans reste la police unifiée." action={canWrite?<Button busy={busy} onClick={save}>Publier le design</Button>:undefined}/>
  <div className="admin-report-grid">
