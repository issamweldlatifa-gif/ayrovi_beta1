...
const navGroups = [
  ...
  { label: 'Contenu', items: [
    ...
    { id: 'promotions', label: 'Promotions', icon: Gift, permission: 'content:read' as Permission }, { id: 'stories-studio', label: 'Stories', icon: ChartLine, permission: 'content:read' as Permission },
