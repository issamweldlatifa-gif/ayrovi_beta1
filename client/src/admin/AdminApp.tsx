...
import {
  AlertCircle, Bell, Calculator, Calendar, Camera, ChartLine, CheckCircle2, CreditCard, FileText, FigLeaf, Gift, Globe2, Grid,
...
const navGroups = [
  ...
  { label: 'Contenu', items: [
    ...
    { id: 'promotions', label: 'Promotions', icon: Gift, permission: 'content:read' as Permission }, { id: 'stories-studio', label: 'Social Ayrovi', icon: ChartLine, permission: 'content:read' as Permission },
...
const LoginPage: React.FC<{ onAuthenticated: (user: UserIdentity) => void }> = ({ onAuthenticated }) => {
  ...
  return (
    <main className="admin-login">
      <section className="admin-login-brand"><div className="admin-login-brand__mark"><img src="/media/logo-ayrovi.jpg" alt="AYROVI" style={{width:40,height:40,borderRadius:12,objectFit:"cover"}} /></div><span>AYROVI / CONTROL</span><h1>Le commerce mondial,<br />piloté depuis Tunis.</h1><p>Contenu, arrivages, commandes, tarification et assistance — une seule source de vérité.</p><div className="admin-login-grid"><article><strong>24</strong><span>gouvernorats</span></article><article><strong>4</strong><span>rôles sécurisés</span></article><article><strong>100%</strong><span>backend-driven</span></article></div></section>
      <section className="admin-login-panel"><div className="admin-login-box"><div className="admin-login-mobile-logo"><img src="/media/logo-ayrovi.jpg" alt="AYROVI" style={{width:28,height:28,borderRadius:8,objectFit:"cover"}} /><strong>AYROVI</strong></div><span className="admin-eyebrow">Espace sécurisé</span><h2>Bienvenue.</h2><p>Connectez-vous avec le compte administrateur configuré sur le serveur.</p>
