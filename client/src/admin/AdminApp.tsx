...
const CustomersPage: React.FC = () => {
  ...
  return <><PageHeader title="Clients" description="Fiches historiques et comptes clients vérifiés restent distincts, reliés uniquement par leurs commandes sécurisées."/><section className="admin-list-card"><div className="admin-list-toolbar"><Search value={search} onChange={setSearch} placeholder="Nom ou téléphone…"/></div><DataTable rows={rows} loading={loading} onRowClick={open} columns={[
