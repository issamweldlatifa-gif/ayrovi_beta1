...
export const Footer: React.FC<FooterProps> = ({ onOpenAccount, onOpenAssistant, logoUrl = '/media/logo-ayrovi-black.png', coverImage, introTitle, introText }) => {
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-9 space-y-3 text-xs">
          <div className="flex items-center gap-2.5">
            <img src={logoUrl} alt="" className="ayrovi-logo-black h-10 w-10 object-contain" />
