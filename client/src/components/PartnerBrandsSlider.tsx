  ...
  return (
    <section className="w-full bg-white py-16 sm:py-24">
      <div className="relative isolate mx-auto mb-10 w-full max-w-4xl overflow-hidden px-5 py-8 text-center sm:mb-14 sm:px-8 sm:py-12">
        ...
        <div className="mb-4 inline-flex items-center gap-3 text-xs font-extrabold uppercase tracking-[0.2em] text-brand sm:text-sm"><span className="h-[2px] w-7 bg-brand/25" />Marques partenaires<span className="h-[2px] w-7 bg-brand/25" /></div>
