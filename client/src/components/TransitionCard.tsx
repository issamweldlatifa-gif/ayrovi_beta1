...
export const TransitionCard: React.FC = () => (
  <section aria-label={TITLE} className="transition-card-fade relative mx-5 overflow-hidden rounded-[22px] bg-[#FF7A00] px-7 py-7 text-white sm:mx-6 lg:mx-auto lg:max-w-7xl lg:rounded-[24px] lg:px-8 lg:py-8" style={{ marginBottom: 0 }}>
