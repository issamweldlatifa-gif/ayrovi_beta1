...
export function VoiceLevel({ level, muted = false }: { level: number; muted?: boolean }) {
  ...
  return <svg className="editorial-voice-level" data-visualization="audio-level" aria-hidden="true" focusable="false" viewBox="0 0 100 40" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="square">
