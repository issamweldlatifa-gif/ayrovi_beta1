...
- سماكة الخط المرصودة في الملف تقارب 12 px ضمن رموز بعرض يقارب 200–280 px؛ التطبيع المناسب على شبكة 24 هو **1.75 وحدة**.
...
| Canvas | `24 × 24` |
| ViewBox | `0 0 24 24` |
| Stroke | `1.75` عبر `--ayrovi-icon-stroke` |
...
- الرموز الدلالية الثانوية تعتمد أشكالًا هندسية من Lucide من خلف البوابة، لكن CSS العام يفرض عليها وزن AYROVI وخصائص الرسم ذاتها.
...
5. لا تغيّر سماكة أيقونة منفردة إلا بسبب بصري موثق؛ القيمة الافتراضية هي `--ayrovi-icon-stroke: 1.75`.
