...
export const ERP_MODULES: readonly ErpModuleDefinition[] = [
  ...
  { key: 'catalog', label: 'Catalogue', section: 'OPERATIONS', status: 'legacy', basePermission: 'content:read', adminSection: 'products', description: 'Produits, marques, promotions (moteur tarifaire backend)' },
