...
function Fixture(){
 ...
 const state = ((window as any).lensResultsTest ||= { searches:[],choices:[],resets:0,accountOpens:0 });
 Object.assign(state,{setLoading,setHasImage,setItems,setDetected,setPreview,image,setSession});
 return <div style={{position:'fixed',inset:0}}><InteractiveLensResults shell customerSession={session} onOpenFavorites={()=>{state.accountOpens++;}} previewUrl={hasImage?preview:null} fallbackImage={null}
